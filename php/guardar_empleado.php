...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_check = "SELECT idEmpleado FROM empleado WHERE Nombre_Completo = ?";
    $stmt_check = $conn->prepare($sql_check);
    $stmt_check->bind_param("s", $empleado_nombre);
    $stmt_check->execute();
        ...
        <body>
            <script>
                Swal.fire({
                    ...
                    text: 'Ya existe un empleado registrado con ese nombre.',
