    ...
    <div class="col-md-12 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="./guardar/guardar_huespedxestadia.php" method="POST" enctype="multipart/form-data" id="formulario-estadia">
              <div class="mb-3">
                <label for="id_huesped" class="form-label">Identificación del Huesped</label>
