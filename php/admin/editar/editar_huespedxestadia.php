    ...
    <div class="col-md-12 mb-3">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="./actualizar/actualizar_huespedxestadia.php" method="post" enctype="multipart/form-data">        
            ...
            <div class="mb-3">
              <label for="id_huesped_nuevo" class="form-label">Documento del Huesped</label>
