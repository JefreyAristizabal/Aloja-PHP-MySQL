    ...
    <div class="col-md-12 mb-3">
      <div class="card">
        <div class="card-header">
          <span><i class="bi bi-plus me-2"></i></span> Agregar Huésped
        </div>
        <div class="card-body">
          <h2>Agregar Huésped</h2>
          <form action="./guardar/guardar_huesped.php" id="formReserva" method="POST" enctype="multipart/form-data" novalidate>

            <!-- Nombre -->
            <div class="form-floating my-3">
              <input type="text" name="nombre_huesped" id="nombre_huesped" class="form-control" required>
            ...
            <div class="input-group mb-3">
              ...
              <div class="valid-feedback d-none ms-2">Opción válida.</div>
              <div class="invalid-feedback d-none ms-2">Selecciona un tipo de documento.</div>
            </div>

            <!-- Documento -->
            <div class="form-floating my-3">
              <input type="text" name="numero_documento_huesped" id="numero_documento_huesped" class="form-control" required>
            ...
            <!-- Teléfono -->
            <div class="form-floating my-3">
              <input class="form-control" type="text" name="telefono_huesped" id="telefono_huesped" required>
              <label for="telefono_huesped">Teléfono</label>
              <div class="valid-feedback d-none">Teléfono válido.</div>
              <div class="invalid-feedback d-none">Ingresa un teléfono válido (mínimo 7 dígitos).</div>
            </div>

            <!-- Ciudad -->
            <div class="form-floating my-3">
              <input type="text" name="ciudad_huesped" id="ciudad_huesped" class="form-control">
            ...
            <!-- Contacto -->
            <div class="form-floating my-3">
              <input class="form-control" type="text" name="nombre_contacto_huesped" id="nombre_contacto_huesped">
            ...
            <div class="form-floating my-3">
              <input class="form-control" type="text" name="telefono_contacto_huesped" id="telefono_contacto_huesped">
            ...
            <div class="input-group mb-3">
              ...
              <textarea class="form-control" name="observaciones_huesped" id="observaciones_huesped"></textarea>
            </div>

            <div class="input-group mb-3">
              <span class="input-group-text">Otras Observaciones</span>
              <textarea class="form-control" name="otras_observaciones_huesped" id="otras_observaciones_huesped"></textarea>
            </div>
...
<!-- Validación JS -->
<!-- ...encabezado PHP y formulario igual... -->
